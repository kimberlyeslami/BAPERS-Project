 ...
 */
public class IndividualPerformanceReportForm extends javax.swing.JFrame {
    /**New JFrame */
    ...
    private IndividualPerformanceReport ipr;
    /** Array list with the Reports */
    private ArrayList<ResultSet> reports;
    /** The Employees ID. */
     ...
     * @param end end date
     * @param empID The employeeID
     */
    public IndividualPerformanceReportForm(JFrame frame, String jobRole, Date start, Date end, String empID) {
        this.empID = empID;
        this.frame = frame;
        ...
        ipr = new IndividualPerformanceReport(start, end);
        
        if (frame.getName().equals("viewReports")){
            reports = ipr.generate(false);
        } else {
            reports = ipr.generate(true);
        }
    ...
    private void initComponents() {
        ...
        IndvPerfReport_lbl = new javax.swing.JLabel();
        ...
        IndvPerfReport_lbl.setBackground(new java.awt.Color(0, 153, 255));
        IndvPerfReport_lbl.setFont(new java.awt.Font("Arial", 1, 36)); // NOI18N
        IndvPerfReport_lbl.setForeground(new java.awt.Color(255, 255, 255));
        IndvPerfReport_lbl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        IndvPerfReport_lbl.setText("Individual Performance Report");
        IndvPerfReport_lbl.setOpaque(true);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(89, 89, 89)
                .addComponent(IndvPerfReport_lbl, javax.swing.GroupLayout.PREFERRED_SIZE, 549, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(IndvPerfReport_lbl)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(print_btn, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(127, 127, 127))
        );
    ...
    private void print_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print_btnActionPerformed
        MessageFormat header = new MessageFormat(ipr.getReptName() + "\n" + period_lbl.getText());
        MessageFormat footer = new MessageFormat("Page{0, number, integer}");
        
        try {
            report_tbl.print(JTable.PrintMode.NORMAL, header, footer);
        } catch (PrinterException ex) {
            Logger.getLogger(IndividualPerformanceReportForm.class.getName()).log(Level.SEVERE, null, ex);
     ...
     * @return a table populated with the reports.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IndividualPerformanceReportForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IndividualPerformanceReportForm(new Generate_Report("Office Manager", "FG12"), "Office Manager", new Date(new GregorianCalendar(2018, 01, 24).getTimeInMillis()), new Date(new GregorianCalendar(2018, 01, 24).getTimeInMillis()), "FG12").setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel IndvPerfReport_lbl;
